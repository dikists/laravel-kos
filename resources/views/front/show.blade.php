...
<div class="row">
  ...
  <div class="col-lg-12 col-xl-4">
    <div class="card">
      <div class="card-content">
        <div class="card-body ">
          <img src="{{asset('assets/images/pages/empty.svg')}}" width="50px" height="50px" class="rounded">
        ...
        <hr>
          <h3 style="font-weight: bold">Reviews</h3> <br>
            @foreach ($kamar->reviews as $review)
              <div class="mb-3">
                <img src="{{asset('assets/images/profile/profile.jpg')}}" width="40px" height="40px" class="rounded">
